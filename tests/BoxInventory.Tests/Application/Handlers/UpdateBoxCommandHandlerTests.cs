...
public class UpdateBoxCommandHandlerTests
{
    ...
    public async Task Handle_ExistingBox_UpdatesAndReturns()
    {
        ...
        var result = await _handler.Handle(new UpdateBoxCommand(id, "New Name", null, "/new", null, null), default);
    ...
    public async Task Handle_NonExistentBox_Throws()
    {
        ...
        Func<Task> act = () => _handler.Handle(
            new UpdateBoxCommand("507f1f77bcf86cd799439011", null, null, null, null, null), default);
    ...
    public async Task Handle_NullItems_KeepsExisting()
    {
        ...
        var result = await _handler.Handle(new UpdateBoxCommand(id, "Updated", null, null, null, null), default);
    ...
    public async Task Handle_WithItems_ReplacesExisting()
    {
        ...
        var result = await _handler.Handle(new UpdateBoxCommand(id, "Name", null, null, null, items), default);
