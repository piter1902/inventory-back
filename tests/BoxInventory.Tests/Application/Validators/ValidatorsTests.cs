...
public class ValidatorsTests
{
    ...
    public void CreateBoxCommand_Valid_Passes()
    {
        ...
        var command = new CreateBoxCommand("Caja", null, null);
    ...
    public void CreateBoxCommand_WithValidItems_Passes()
    {
        ...
        var command = new CreateBoxCommand("Caja", null, items);
    ...
    public void UpdateBoxCommand_Valid_Passes()
    {
        ...
        var command = new UpdateBoxCommand(ValidId, null, null, null);
    ...
    {
        var validator = new UpdateBoxCommandValidator();
        var command = new UpdateBoxCommand("", null, null, null);
    ...
    public void UpdateBoxCommand_WithValidItems_Passes()
    {
        ...
        var command = new UpdateBoxCommand(ValidId, null, null, items);
